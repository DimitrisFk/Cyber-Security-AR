...
public class EmailManager : MonoBehaviour
{
    ...
    public void SendEmail()
    {
        ...
        mail.From = new MailAddress("arcybersecuriteam@gmail.com");
        mail.To.Add(new MailAddress("arcybersecuriteam@gmail.com"));

        mail.Subject = "Σχόλια του χρήστη " + dispName;
        mail.Body = bodyMessage.text;


        SmtpServer.Credentials = new System.Net.NetworkCredential("arcybersecuriteam@gmail.com", "ASAkis1122!!") as ICredentialsByHost; SmtpServer.EnableSsl = true;
